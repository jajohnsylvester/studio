...
import { ArrowDownCircle, Banknote, Landmark, CreditCard, CheckCircle } from 'lucide-react';
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="hover:bg-muted/50 transition-colors">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
             ...
             <p className="text-xs text-muted-foreground">Excluding all Credit Card bills</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Total of paid CC expenses</p>
          </CardContent>
        </Card>
        <Card className={isOverBudget ? "bg-destructive/10 border-destructive" : ""}>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Based on total budget</p>
          </CardContent>
        </Card>
    </div>
  );
